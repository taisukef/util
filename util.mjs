...
exports.create = function (tag, cls) {
...
exports.cr = exports.create
exports.clear = function (id) {
  var div = typeof id === 'string' ? exports.get(id) : id
...
exports.jsonp = function (url, callback) {
  ...
  if (callback) {
    ...
    url += 'callback=' + exports.getCallbackMethod(callback)
  }
...
exports.xml2json = function (xml) { // attribute無視、名前重なったら配列化
  var f = function (xml) {
    ...
    for (var i = 0; i < xml.childNodes.length; i++) {
      ...
      if (name === '#text') { text.push(node.textContent) } else {
        hasxml = true
        if (json[name] == null) {
          json[name] = f(node)
        } else {
...
exports.debug = function (s) {
  var d = exports.get('debug')
  if (d == null) {
    d = exports.create('div')
    d.id = 'debug'
...
exports.dumpInner = function (o, name, depth, target) {
  ...
  for (const n in o) {
    if (typeof o[n] === 'object') {
      const div = exports.create('div')
      div.style.paddingLeft = (depth * 30) + 'px'
      div.textContent = n
      target.appendChild(div)
      exports.dumpInner(o[n], n, depth + 1, target)
    } else {
      const s = n + ': ' + o[n]
      //    alert(n + " " + o[n]);
      const div = exports.create('div')
...
exports.dumpXML = function (xml, comp) {
  if (comp == null) {
    exports.debug('')
    comp = exports.get('debug')
  }
  var f = function (xml, n) {
    for (var i = 0; i < xml.childNodes.length; i++) {
      var node = xml.childNodes[i]
      var name = node.nodeName
      var div = exports.create('div')
      var s = []
...
exports.splitString = function (s, splitters) {
  ...
  for (let i = 0; i < s.length; i++) {
    ...
    if (splitters.indexOf(c) >= 0) {
      if (i > n) { res.push(s.substring(n, i)) }
      n = i + 1
    }
  }
